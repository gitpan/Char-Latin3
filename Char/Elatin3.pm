...
BEGIN {
    ...
    sub Char::Elatin3::binmode(*;$);
    sub Char::Elatin3::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Elatin3::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Elatin3::open;
    }
}
...
=item Make character
  ...
  set. For example, Char::Elatin3::chr(65) is "A" in either ASCII or Latin-3, and
  Char::Elatin3::chr(0x82a0) is a Latin-3 HIRAGANA LETTER A. For the reverse of Char::Elatin3::chr,
  use Char::Latin3::ord.
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Elatin3::binmode(FILEHANDLE, $disciplines);
  Char::Elatin3::binmode(FILEHANDLE);
  Char::Elatin3::binmode($filehandle, $disciplines);
  Char::Elatin3::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Elatin3::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Elatin3::open(FILEHANDLE, $expr);
  $rc = Char::Elatin3::open(FILEHANDLE);
  $rc = Char::Elatin3::open(my $filehandle, $mode, $expr);
  $rc = Char::Elatin3::open(my $filehandle, $expr);
  $rc = Char::Elatin3::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Elatin3::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Elatin3::open my $fh, ">logfile" or die ...
  ...
  Char::Elatin3::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Elatin3::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Elatin3::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Elatin3::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Elatin3::open(FH, "<:crlf:encoding(Char::Latin3)", $path) or die "can't open $path: $!";
