...
######################################################################
#
# Char::Latin3 - Source code filter to Latin-3 script
#
...
sub Char::Latin3::escape_script {
    ...
    if (/^ use Char::Elatin3(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin3 %s;\n%s", $Char::Elatin3::VERSION, $use_re_eval); # require run-time routines version
...
Char::Latin3 - Source code filter to escape Latin-3

=head1 SYNOPSIS

  use Char::Latin3;
  use Char::Latin3 version;         --- require version
