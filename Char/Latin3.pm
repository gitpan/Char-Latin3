...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin3::function_ord     = 'Char::Latin3::ord'     if /\A ord \z/oxms;
                    $Char::Elatin3::function_ord_    = 'Char::Latin3::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin3::function_reverse = 'Char::Latin3::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin3::function_getc    = 'Char::Latin3::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin3::escape();
...
=head1 Calling 'Char::Elatin3::ignorecase()' (Char::Latin3 software provides)

Char::Latin3 software applies calling 'Char::Elatin3::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin3 software provides)

Char::Latin3 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin3 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin3 software provides)

Char::Latin3 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin3 software and
