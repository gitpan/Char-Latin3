...
#               $pattern .= "(?:$your_char)",   # UNIX style
        ...
        my $matchsub = sub { Elatin3::fc($_[0]) =~ m{\A $pattern \z}xms };
...
=item Chop string
  ...
  character chopped. The Elatin3::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Elatin3::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Elatin3::fc function for case-insensitive comparisons via Latin3
  software.
...
=item Fold case string
  ...
  New to Latin3 software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Elatin3::glob function grandfathers the use of whitespace to separate multiple
