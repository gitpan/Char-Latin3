...
=item Make character
  ...
  set. For example, Elatin3::chr(65) is "A" in either ASCII or Latin-3, not Unicode,
  and Elatin3::chr(0x82a0) is a Latin-3 HIRAGANA LETTER A. For the reverse of
  Elatin3::chr, use Latin3::ord.
