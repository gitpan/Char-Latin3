...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Elatin3::uc($char[$i]) ne Elatin3::lc($char[$i]))) {
            $char[$i] = '[' . Elatin3::uc($char[$i]) . Elatin3::lc($char[$i]) . ']';
        }
...
=item * Only Latin3.pm and Elatin3.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Elatin3::lc
  lcfirst     Elatin3::lcfirst
  uc          Elatin3::uc
  ucfirst     Elatin3::ucfirst
  chr         Elatin3::chr
  glob        Elatin3::glob
  ---------------------------------
...
Latin3.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Elatin3.pm
  --------------------------------------------------------------------
  binmode(...);   Elatin3::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Elatin3::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Latin3 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Latin3 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Latin3)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Elatin3.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Elatin3.pm provides bytes::*
