...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ m/\A [\x00-\xFF] \z/oxms) and (Elatin3::uc($char[$i]) ne Elatin3::lc($char[$i]))) {
...
http://search.cpan.org/dist/Char-Latin3/Latin3/JA.pm
