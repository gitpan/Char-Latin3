...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin3 software provides)

Latin3 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin3 software provide)
